...
namespace ScaleFinderConsole
{
    class Program
    {
        static void Main(string[] args)
        {
            ...
            Chord MajorChord = new Chord("10001001", "Major", "maj");
            Chord MinorChord = new Chord("10010001", "Minor", "min");
            Chord AugmentedChord = new Chord("100010001", "Augmented", "aug");
            Chord DiminishedChord = new Chord("1001001", "Diminished", "aug");
            Chord SuspendedChord = new Chord("10100001", "Suspended Second", "sus2");
            Chord SuspendedFourthChord = new Chord("10000101", "Suspended Fourth", "sus4");
            Chord SixthChord = new Chord("1000100101", "Sixth", "maj6");
            Chord MinorSixthChord = new Chord("1001000101", "Minor Sixth", "min6");
            Chord SeventhChord = new Chord("10001001001", "Seventh", "7");
            Chord MajorSeventhChord = new Chord("100010010001", "Major Seventh", "maj7");
            Chord MinorSeventhChord = new Chord("10010001001", "Minor Seventh", "min7");
            Chord MinorMajorSeventhChord = new Chord("100100010001", "Minor Major Seventh", "minMaj7");
            Chord DiminishedSeventhChord = new Chord("1001001001", "Diminished Seventh", "dim7");
            Chord HalfDiminishedChord = new Chord("10010010001", "Half Diminished", "min7b5");
            Chord SeventhDiminishedFifthChord = new Chord("10001010001", "Seventh Diminished Fifth", "7b5");
            Chord SeventhAugmentedFifthChord = new Chord("10001000101", "Seventh Augmented Fifth", "7#5");
            Chord MajorSeventhDiminishedFifthChord = new Chord("100010100001", "Major Seventh Diminished Fifth", "maj7b5");
            Chord MajorSeventhAugmentedFifthChord = new Chord("100010001001", "Major Seventh Augmented Fifth", "maj7#5");
            Chord SeventhSuspendedFourthChord = new Chord("10000101001", "Seventh Suspended Fourth", "7sus4");
            Chord SeventhSuspendedFourthAugmentedFifthChord = new Chord("10000100101", "Seventh Suspended Fourth Augmented Fifth", "7sus4#5");
